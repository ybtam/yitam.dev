...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center">
      <section className="bg-muted flex w-full justify-center py-12 md:py-24 lg:py-32 xl:py-48">
        <div className="container px-4 md:px-6">
          <div className="mx-auto flex max-w-[1100px] justify-between gap-10">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground max-w-[600px] md:text-xl">
                  A passionate software engineer specializing in building exceptional digital
                  experiences.
                </p>
              </div>
            ...
            <div className="flex items-center justify-center">
              <div className="border-primary relative h-[300px] w-[300px] overflow-hidden rounded-full border-4 md:h-[400px] md:w-[400px]">
                <Image
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ...
                problems. With expertise in web development, I build applications that are both
                ...
                <li>
                  <div className="grid gap-1">
                    ...
                    <p className="text-muted-foreground">
                      Over X years of experience in software development, working with various
      ...
      <section className="bg-muted flex w-full justify-center py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <Card key={i} className="overflow-hidden">
                ...
                <CardContent className="p-4">
                  <div className="mb-2 flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground text-xs">April 1, 2023</span>
                  </div>
